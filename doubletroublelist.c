 ...
 * Concatenate two lists: 55 2 12 4 5 11 3 14 14 7 15 30 60 120l
...
void swap(struct node* ref1, struct node* ref2) {
    ...
    if ((ref1next != ref2) && (ref2next!=ref1) && (ref1prev != NULL) && (ref2next != NULL))
    {
        ref1prev -> next = ref2;
        ref1 -> next = ref2next;
        ref1 -> prev = ref2prev;
    ...
    if ((ref1prev == NULL) && (ref2next != NULL))
    {
        ref1 -> next = ref2next;
        ref1 -> prev = ref2prev;
        ref1next -> prev = ref2;
    ...
    if ((ref2prev == NULL) && (ref1next != NULL))
    {
        ref2 -> next = ref1next;
        ref2 -> prev = ref1prev;
        ref2next -> prev = ref1;
...
struct node* shift_left(struct node* ref, int n) {
    ...
    /* struct node* refprevprev = prev(refprev);
    struct node* refnextnext = prev(refnext); */
    ...
    /* for (i = 0; i < n; i++)
    {
        refprevprev -> next = ref;
        ref -> prev = refprevprev;
        refprev -> next = NULL;
        refprev -> prev = NULL;
...
int main() {
    ...
    /* printf("Shift left 11, 2 times: ");
    shift_left(ffind(begin(list), 11), 2);
    print(list); */
